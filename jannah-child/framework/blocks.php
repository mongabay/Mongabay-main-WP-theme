		...
		if( ! empty( $section['blocks'] ) && is_array( $section['blocks'] ) ) {
			...
			foreach( $section['blocks'] as $block ){
				 ...
				 */
					...
					$query_args = $block;
                    // Añadimos post_type a los argumentos de nuestra consulta como opción
                    $query_args['post_type'] = !empty($block['post_type']) ? $block['post_type'] : 'post'; // Establecemos 'post' como el tipo predeterminado
