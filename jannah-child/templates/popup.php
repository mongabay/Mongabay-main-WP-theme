...
if( ! function_exists( 'tie_popup_search_html' ) ){
		...
		<div id="<?php echo esc_attr( $id ) ?>" class="tie-popup tie-popup-search-wrap" style="display: none;">
			...
			<div class="popup-search-wrap-inner">
				...
				<?php
					...
					//include '/nas/content/live/mongabaydev/gql_search.html';
			...
			<div class="container-wrapper">
				<div class="widget login-widget">
					...
					<div <?php tie_box_class( 'widget-title' ) ?>>
						<div class="the-subtitle"><?php esc_html_e( 'Log In', TIELABS_TEXTDOMAIN ) ?> <span class="widget-title-icon tie-icon"></span></div>
					</div>
